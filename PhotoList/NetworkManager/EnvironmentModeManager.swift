...
//MARK: =========================== beta =============================
let onlineBaseUrl = "https://picsum.photos"
let onlineRealTimeUrl = "https://picsum.photos"
let onlineRealTimeChatUrl = "https://picsum.photos"
//MARK: =========================== staging =============================
...
enum EnvironmentMode {
    ...
    var baseUrl: String {
        ...
        switch self {
            ...
            case .offline:
                return String(format: "http://%@:8005", "")
        }
    ...
    var realTimeUrl: String {
        ...
        switch self {
            ...
            case .offline:
                return String(format: "http://%@:9092","")
            }
